...
exports.otherOperating = exports.administrativeExpensesChart = exports.costOfSalesChart = exports.otherIncomeChart = exports.revenueChart = exports.assetsChart = exports.liabilitiesChart = exports.equityChart = void 0;
...
exports.administrativeExpensesChart = [
    {
        code: '7',
...
async function seedAccounts(prisma, accounts, parentId = null) {
        ...
        for (const company of companies) {
            ...
            try {
                ...
                try {
                    ...
                    await seedAccounts(tenantPrisma, exports.equityChart);
                    console.log(`   Seeding Liabilities Chart...`);
                    await seedAccounts(tenantPrisma, exports.liabilitiesChart);
                    console.log(`   Seeding Assets Chart...`);
                    await seedAccounts(tenantPrisma, exports.assetsChart);
                    console.log(`   Seeding Revenue Chart...`);
                    await seedAccounts(tenantPrisma, exports.revenueChart);
                    console.log(`   Seeding Other Income Chart...`);
                    await seedAccounts(tenantPrisma, exports.otherIncomeChart);
                    console.log(`   Seeding Cost of Sales Chart...`);
                    await seedAccounts(tenantPrisma, exports.costOfSalesChart);
                    console.log(`   Seeding Administrative Expenses Chart...`);
                    await seedAccounts(tenantPrisma, exports.administrativeExpensesChart);
                    console.log(`   Seeding Other Operating Expenses Chart...`);
                    await seedAccounts(tenantPrisma, exports.otherOperating);
                    console.log(`   ✅ Success!`);
                }
                finally {
...
//# sourceMappingURL=chart-of-account.js.map