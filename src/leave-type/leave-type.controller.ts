...
export class LeaveTypeController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Annual' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Sick' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { name: { type: 'string' }, status: { type: 'string' } }, example: [{ name: 'Annual' }] } } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, name: { type: 'string' }, status: { type: 'string' } }, example: [{ id: 'uuid', name: 'Sick' }] } } } } })
