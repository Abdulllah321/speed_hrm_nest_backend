...
export class JobTypeController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Full Time' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { names: { type: 'array', items: { type: 'string' }, example: ['Full Time', 'Part Time'] } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Internship' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, name: { type: 'string' } }, example: [{ id: 'uuid', name: 'Contract' }] } } } } })
