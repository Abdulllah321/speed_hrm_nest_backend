...
export class DepartmentController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'QA' }, departmentId: { type: 'string', example: 'dept-uuid' }, headId: { type: 'string', example: 'user-uuid' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { name: { type: 'string' }, departmentId: { type: 'string' }, headId: { type: 'string' } } } } } } })
  ...
  @ApiBody({ schema: { type: 'array', items: { type: 'string', example: 'uuid' } } })
