...
import { CreateBrandDto, UpdateBrandDto, BulkUpdateBrandItemDto } from './dto/brand.dto';
...
export class BrandService {
    ...
    async getAllBrands() {
        ...
        const userIds = [...new Set(brands.map((b) => b.createdById).filter(Boolean))];
        ...
        const data = brands.map((brand) => {
            ...
            return {
                ...brand,
                createdBy: creator ? `${creator.firstName} ${creator.lastName || ''}`.trim() : null,
    ...
    async createBrands(items: CreateBrandDto[], createdById: string) {
        try {
            ...
            return { status: true, data: brands, message: 'Brands created successfully' };
        } catch (error: any) {
    ...
    async updateBrand(
        ...
        try {
            const existing = await this.prismaMaster.brand.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('brands_all');
            return { status: true, data: brand, message: 'Brand updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateBrands(
        ...
        try {
            ...
            await this.cacheManager.del('brands_all');
            return { status: true, data: updated, message: 'Brands updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteBrands(
        ...
        try {
            ...
            await this.cacheManager.del('brands_all');
            return { status: true, data: result, message: 'Brands deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteBrand(
        ...
        try {
            ...
            await this.cacheManager.del('brands_all');
            return { status: true, data: result, message: 'Brand deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async getAllDivisions() {
        ...
        const userIds = [...new Set(divisions.map((d) => d.createdById).filter(Boolean))];
        const users = await this.prismaMaster.user.findMany({
            where: { id: { in: userIds as string[] } },
            select: { id: true, firstName: true, lastName: true },
        });
    ...
    async createDivisions(
        ...
        try {
            ...
            return { status: true, data: divisions, message: 'Divisions created successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateDivisions(
        ...
        try {
            ...
            await this.cacheManager.del('divisions_all');
            await this.cacheManager.del('brands_all');
            return { status: true, data: updated, message: 'Divisions updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateDivision(
        ...
        try {
            const existing = await this.prismaMaster.division.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('divisions_all');
            await this.cacheManager.del('brands_all');
            return { status: true, data: division, message: 'Division updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteDivisions(
        ...
        try {
            ...
            await this.cacheManager.del('divisions_all');
            await this.cacheManager.del('brands_all');
            return { status: true, data: result, message: 'Divisions deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteDivision(
        ...
        try {
            ...
            await this.cacheManager.del('divisions_all');
            await this.cacheManager.del('brands_all');
            return { status: true, data: result, message: 'Division deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
