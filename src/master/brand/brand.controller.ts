...
import { UpdateBrandDto, BulkUpdateBrandDto, CreateBrandDto } from './dto/brand.dto';
import { CreateDivisionDto, UpdateDivisionDto, BulkUpdateDivisionDto } from './dto/division.dto';
...
export class BrandController {
    ...
    async createDivisions(@Body() body: { items: CreateDivisionDto[] }, @Req() req) {
    ...
    async updateDivision(@Param('id') id: string, @Body() dto: UpdateDivisionDto, @Req() req) {
