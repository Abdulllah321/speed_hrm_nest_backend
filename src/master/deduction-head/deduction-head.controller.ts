...
import {
  CreateDeductionHeadDto,
  UpdateDeductionHeadDto,
} from './dto/deduction-head.dto';
...
export class DeductionHeadController {
  ...
  async createBulk(
    @Body() body: { items: CreateDeductionHeadDto[] },
    @Req() req,
  ) {
  ...
  async update(
    @Param('id') id: string,
    @Body() body: UpdateDeductionHeadDto,
    @Req() req,
  ) {
  ...
  async updateBulk(
    @Body() body: { items: UpdateDeductionHeadDto[] },
    @Req() req,
  ) {
