...
import { CreateGenderDto, UpdateGenderDto, BulkUpdateGenderItemDto } from './dto/gender.dto';
...
export class GenderService {
    ...
    async getAllGenders() {
        ...
        const userIds = [...new Set(genders.map((g) => g.createdById).filter(Boolean))];
        ...
        const data = genders.map((gender) => {
            const creator = gender.createdById ? userMap.get(gender.createdById) : null;
            return {
                ...gender,
    ...
    async createGenders(items: CreateGenderDto[], createdById: string) {
        try {
            ...
            return { status: true, data: genders, message: 'Genders created successfully' };
        } catch (error: any) {
    ...
    async updateGender(
        ...
        try {
            const existing = await this.prismaMaster.gender.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('genders_all');
            return { status: true, data: gender, message: 'Gender updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateGenders(
        ...
        try {
            ...
            await this.cacheManager.del('genders_all');
            return { status: true, data: updated, message: 'Genders updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteGenders(
        ...
        try {
            ...
            await this.cacheManager.del('genders_all');
            return { status: true, data: result, message: 'Genders deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteGender(
        ...
        try {
            ...
            await this.cacheManager.del('genders_all');
            return { status: true, data: result, message: 'Gender deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
