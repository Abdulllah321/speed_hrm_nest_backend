...
import { CreateSizeDto, UpdateSizeDto, BulkUpdateSizeItemDto } from './dto/size.dto';
...
export class SizeService {
    ...
    async getAllSizes() {
        ...
        const userIds = [...new Set(sizes.map((s) => s.createdById).filter(Boolean))];
    ...
    async createSizes(items: CreateSizeDto[], createdById: string) {
        try {
            ...
            return { status: true, data: sizes, message: 'Sizes created successfully' };
        } catch (error: any) {
    ...
    async updateSize(
        ...
        try {
            const existing = await this.prismaMaster.size.findUnique({ where: { id } });
    ...
    async updateSizes(
        ...
        try {
            ...
            await this.cacheManager.del('sizes_all');
            return { status: true, data: updated, message: 'Sizes updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteSizes(
        ...
        try {
            ...
            await this.cacheManager.del('sizes_all');
            return { status: true, data: result, message: 'Sizes deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteSize(
        ...
        try {
            ...
            await this.cacheManager.del('sizes_all');
            return { status: true, data: result, message: 'Size deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
