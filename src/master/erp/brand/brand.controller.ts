...
export class BrandController {
  ...
  @Post('brands')
  @UseGuards(JwtAuthGuard, PermissionGuard('master.brand.create'))
  @ApiBearerAuth()
  ...
  @Put('brands/bulk')
  @UseGuards(JwtAuthGuard, PermissionGuard('master.brand.update'))
  @ApiBearerAuth()
  ...
  @Delete('brands/bulk')
  @UseGuards(JwtAuthGuard, PermissionGuard('master.brand.delete'))
  @ApiBearerAuth()
  ...
  @Post('divisions')
  @UseGuards(JwtAuthGuard, PermissionGuard('master.division.create'))
  @ApiBearerAuth()
  ...
  @Put('divisions/bulk')
  @UseGuards(JwtAuthGuard, PermissionGuard('master.division.update'))
  @ApiBearerAuth()
  ...
  @UseGuards(JwtAuthGuard, PermissionGuard('master.division.delete'))
  @ApiBearerAuth()
