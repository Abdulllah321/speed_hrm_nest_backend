...
import { CreateSeasonDto, UpdateSeasonDto, BulkUpdateSeasonItemDto } from './dto/season.dto';
...
export class SeasonService {
    ...
    async getAll() {
        ...
        const userIds = [...new Set(seasons.map((s) => s.createdById).filter(Boolean))];
        ...
        const data = seasons.map((season) => {
            const creator = season.createdById ? userMap.get(season.createdById) : null;
            return {
                ...season,
    ...
    async createMany(items: CreateSeasonDto[], createdById: string) {
        try {
            ...
            return { status: true, data: result, message: 'Seasons created successfully' };
        } catch (error: any) {
    ...
    async update(
        ...
        try {
            const existing = await this.prismaMaster.season.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('seasons_all');
            return { status: true, data: season, message: 'Season updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateMany(
        ...
        try {
            ...
            await this.cacheManager.del('seasons_all');
            return { status: true, data: updated, message: 'Seasons updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteMany(
        ...
        try {
            ...
            await this.cacheManager.del('seasons_all');
            return { status: true, data: result, message: 'Seasons deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async delete(
        ...
        try {
            ...
            await this.cacheManager.del('seasons_all');
            return { status: true, data: result, message: 'Season deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
