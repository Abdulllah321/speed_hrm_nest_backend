...
import { CreateSilhouetteDto, UpdateSilhouetteDto, BulkUpdateSilhouetteItemDto } from './dto/silhouette.dto';
...
export class SilhouetteService {
    ...
    async getAllSilhouettes() {
        ...
        const userIds = [...new Set(silhouettes.map((s) => s.createdById).filter(Boolean))];
        ...
        const data = silhouettes.map((silhouette) => {
            const creator = silhouette.createdById ? userMap.get(silhouette.createdById) : null;
            return {
                ...silhouette,
    ...
    async createSilhouettes(items: CreateSilhouetteDto[], createdById: string) {
        try {
            ...
            return { status: true, data: silhouettes, message: 'Silhouettes created successfully' };
        } catch (error: any) {
    ...
    async updateSilhouette(
        ...
        try {
            const existing = await this.prismaMaster.silhouette.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('silhouettes_all');
            return { status: true, data: silhouette, message: 'Silhouette updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateSilhouettes(
        ...
        try {
            ...
            await this.cacheManager.del('silhouettes_all');
            return { status: true, data: updated, message: 'Silhouettes updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteSilhouettes(
        ...
        try {
            ...
            await this.cacheManager.del('silhouettes_all');
            return { status: true, data: result, message: 'Silhouettes deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteSilhouette(
        ...
        try {
            const existing = await this.prismaMaster.silhouette.findUnique({ where: { id } });
            const result = await this.prismaMaster.silhouette.delete({ where: { id } });
            ...
            await this.cacheManager.del('silhouettes_all');
            return { status: true, data: result, message: 'Silhouette deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
