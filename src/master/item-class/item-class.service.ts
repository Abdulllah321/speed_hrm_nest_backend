...
import { CreateItemClassDto, UpdateItemClassDto, BulkUpdateItemClassItemDto } from './dto/item-class.dto';
...
export class ItemClassService {
    ...
    async getAll() {
        ...
        const userIds = [...new Set(classes.map((c) => c.createdById).filter(Boolean))];
        ...
        const data = classes.map((itemClass) => {
            const creator = itemClass.createdById ? userMap.get(itemClass.createdById) : null;
            return {
                ...itemClass,
    ...
    async createMany(items: CreateItemClassDto[], createdById: string) {
        try {
            ...
            return { status: true, data: result, message: 'Item classes created successfully' };
        } catch (error: any) {
    ...
    async update(
        ...
        try {
            const existing = await this.prismaMaster.itemClass.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('item_classes_all');
            return { status: true, data: itemClass, message: 'Item class updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateMany(
        ...
        try {
            ...
            await this.cacheManager.del('item_classes_all');
            return { status: true, data: updated, message: 'Item classes updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteMany(
        ...
        try {
            ...
            await this.cacheManager.del('item_classes_all');
            return { status: true, data: result, message: 'Item classes deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async delete(
        ...
        try {
            const existing = await this.prismaMaster.itemClass.findUnique({ where: { id } });
            const result = await this.prismaMaster.itemClass.delete({ where: { id } });
            ...
            await this.cacheManager.del('item_classes_all');
            return { status: true, data: result, message: 'Item class deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
