...
import { CreateColorDto, UpdateColorDto, BulkUpdateColorItemDto } from './dto/color.dto';
...
export class ColorService {
    ...
    async getAllColors() {
        ...
        const userIds = [...new Set(colors.map((s) => s.createdById).filter(Boolean))];
    ...
    async createColors(items: CreateColorDto[], createdById: string) {
        try {
            ...
            return { status: true, data: result, message: 'Colors created successfully' };
        } catch (error: any) {
    ...
    async updateColor(
        ...
        try {
            const existing = await this.prismaMaster.color.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('colors_all');
            return { status: true, data: result, message: 'Color updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateColors(
        ...
        try {
            ...
            await this.cacheManager.del('colors_all');
            return { status: true, data: updated, message: 'Colors updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteColors(
        ...
        try {
            ...
            await this.cacheManager.del('colors_all');
            return { status: true, data: result, message: 'Colors deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteColor(
        ...
        try {
            ...
            await this.cacheManager.del('colors_all');
            return { status: true, data: result, message: 'Color deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
