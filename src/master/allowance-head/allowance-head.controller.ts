...
import {
  CreateAllowanceHeadDto,
  UpdateAllowanceHeadDto,
} from './dto/allowance-head.dto';
...
export class AllowanceHeadController {
  ...
  async createBulk(
    @Body() body: { items: CreateAllowanceHeadDto[] },
    @Req() req,
  ) {
  ...
  async update(
    @Param('id') id: string,
    @Body() body: UpdateAllowanceHeadDto,
    @Req() req,
  ) {
  ...
  async updateBulk(
    @Body() body: { items: UpdateAllowanceHeadDto[] },
    @Req() req,
  ) {
