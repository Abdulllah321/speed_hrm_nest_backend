...
import { CreateChannelClassDto, UpdateChannelClassDto, BulkUpdateChannelClassItemDto } from './dto/channel-class.dto';
...
export class ChannelClassService {
    ...
    async getAllChannelClasses() {
        ...
        const userIds = [...new Set(channelClasses.map((s) => s.createdById).filter(Boolean))];
    ...
    async createChannelClasses(items: CreateChannelClassDto[], createdById: string) {
        try {
            ...
            return { status: true, data: result, message: 'Channel Classes created successfully' };
        } catch (error: any) {
    ...
    async updateChannelClass(
        ...
        try {
            const existing = await this.prismaMaster.channelClass.findUnique({ where: { id } });
            ...
            await this.cacheManager.del('channel_classes_all');
            return { status: true, data: result, message: 'Channel Class updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async updateChannelClasses(
        ...
        try {
            ...
            await this.cacheManager.del('channel_classes_all');
            return { status: true, data: updated, message: 'Channel Classes updated successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteChannelClasses(
        ...
        try {
            ...
            await this.cacheManager.del('channel_classes_all');
            return { status: true, data: result, message: 'Channel Classes deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
    ...
    async deleteChannelClass(
        ...
        try {
            const existing = await this.prismaMaster.channelClass.findUnique({ where: { id } });
            const result = await this.prismaMaster.channelClass.delete({ where: { id } });
            ...
            await this.cacheManager.del('channel_classes_all');
            return { status: true, data: result, message: 'Channel Class deleted successfully' };
        } catch (error: any) {
            return { status: false, message: error.message, data: null };
        }
    }
