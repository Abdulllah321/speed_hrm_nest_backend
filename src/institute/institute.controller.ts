...
export class InstituteController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'MIT' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Stanford' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { name: { type: 'string' }, status: { type: 'string' } }, example: [{ name: 'MIT' }] } } } } })
