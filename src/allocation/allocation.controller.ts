...
export class AllocationController {
    ...
    @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Allocation 1' } } } })
    ...
    @ApiBody({ schema: { type: 'object', properties: { names: { type: 'array', items: { type: 'string' }, example: ['Allocation 1', 'Allocation 2'] } } } })
