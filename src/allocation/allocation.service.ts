...
export class AllocationService {
    ...
    async create(name: string, ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        try {
            ...
            return { status: true, data: created, message: 'Allocation created successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'create',
            ...
            return { status: false, message: 'Failed to create allocation', data: null };
        }
    }
    ...
    async createBulk(names: string[], ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        ...
        try {
            ...
            return { status: true, data: result, message: 'Allocations created successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'create',
            ...
            return { status: false, message: 'Failed to create allocations', data: null };
        }
    }
    ...
    async update(id: string, name: string, ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        try {
            ...
            return { status: true, data: updated, message: 'Allocation updated successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'update',
            ...
            return { status: false, message: 'Failed to update allocation', data: null };
        }
    }
    ...
    async remove(id: string, ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        try {
            ...
            return { status: true, data: removed, message: 'Allocation deleted successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'delete',
            ...
            return { status: false, message: 'Failed to delete allocation', data: null };
        }
    }
    ...
    async removeBulk(ids: string[], ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        ...
        try {
            ...
            return { status: true, data: ids, message: 'Allocations deleted successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'delete',
            ...
            return { status: false, message: 'Failed to delete allocations', data: null };
        }
    }
    ...
    async updateBulk(items: { id: string; name: string }[], ctx: { userId?: string; ipAddress?: string; userAgent?: string }) {
        ...
        try {
            ...
            return { status: true, data: items, message: 'Allocations updated successfully' };
        } catch (error: any) {
            await this.activityLogs.log({
                userId: ctx.userId,
                action: 'update',
            ...
            return { status: false, message: 'Failed to update allocations', data: null };
        }
    }
}
