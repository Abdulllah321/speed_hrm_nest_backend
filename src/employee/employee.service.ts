    ...
    try {
      const created = await this.prisma.employee.create({
        data: {
          ...
          subDepartmentId: (body.subDepartmentId || body.subDepartment) ?? null,
          employeeGradeId: body.employeeGradeId || body.employeeGrade,
          attendanceId: body.attendanceId,
          designationId: body.designationId || body.designation,
          maritalStatusId: body.maritalStatusId || body.maritalStatus,
          employmentStatusId: body.employmentStatusId || body.employmentStatus,
          ...
          stateId: body.stateId || body.state || body.province,
          cityId: body.cityId || body.city,
          area: body.area ?? null,
          ...
          workingHoursPolicyId: body.workingHoursPolicyId || body.workingHoursPolicy,
          branchId: body.branchId || body.branch,
          leavesPolicyId: body.leavesPolicyId || body.leavesPolicy,
    ...
    try {
      ...
      const updated = await this.prisma.employee.update({
        ...
        data: {
          ...
          departmentId: (body.departmentId || body.department) ?? existing?.departmentId,
          subDepartmentId: (body.subDepartmentId || body.subDepartment) ?? existing?.subDepartmentId,
          employeeGradeId: (body.employeeGradeId || body.employeeGrade) ?? existing?.employeeGradeId,
          attendanceId: body.attendanceId ?? existing?.attendanceId,
          designationId: (body.designationId || body.designation) ?? existing?.designationId,
          maritalStatusId: (body.maritalStatusId || body.maritalStatus) ?? existing?.maritalStatusId,
          employmentStatusId: (body.employmentStatusId || body.employmentStatus) ?? existing?.employmentStatusId,
          ...
          countryId: (body.countryId || body.country) ?? existing?.countryId,
          stateId: (body.stateId || body.state || body.province) ?? existing?.stateId,
          cityId: (body.cityId || body.city) ?? existing?.cityId,
          ...
          workingHoursPolicyId: (body.workingHoursPolicyId || body.workingHoursPolicy) ?? existing?.workingHoursPolicyId,
          branchId: (body.branchId || body.branch) ?? existing?.branchId,
          leavesPolicyId: (body.leavesPolicyId || body.leavesPolicy) ?? existing?.leavesPolicyId,
          ...
          const result = await this.create(
            {
              ...
              departmentId: record.DepartmentId || record.departmentId || record.Department || record.department,
              subDepartmentId: record.SubDepartmentId || record.subDepartmentId || record['Sub Department'] || record['Sub-Department'] || record.SubDepartment || record.subDepartment || null,
              employeeGradeId: record.EmployeeGradeId || record.employeeGradeId || record['Employee-Grade'] || record['Employee Grade'] || record.EmployeeGrade || record.employeeGrade,
              attendanceId: record['Attendance-ID'] || record['Attendance ID'] || record.AttendanceID || record.attendanceId,
              designationId: record.DesignationId || record.designationId || record.Designation || record.designation,
              maritalStatusId: record.MaritalStatusId || record.maritalStatusId || record['Marital Status'] || record['Marital-Status'] || record.MaritalStatus || record.maritalStatus,
              employmentStatusId: record.EmploymentStatusId || record.employmentStatusId || record['Employment Status'] || record['Employment-Status'] || record.EmploymentStatus || record.employmentStatus,
              ...
              countryId: record.CountryId || record.countryId || record.Country || record.country,
              stateId: record.StateId || record.stateId || record.State || record.Province || record.province || record.state,
              cityId: record.CityId || record.cityId || record.City || record.city,
              ...
              workingHoursPolicyId: record.WorkingHoursPolicyId || record.workingHoursPolicyId || record['Working-Hours-Policy'] || record['Working Hours Policy'] || record.WorkingHoursPolicy || record.workingHoursPolicy,
              branchId: record.BranchId || record.branchId || record.Branch || record.branch,
              leavesPolicyId: record.LeavesPolicyId || record.leavesPolicyId || record['Leaves-Policy'] || record['Leaves Policy'] || record.LeavesPolicy || record.leavesPolicy,
