  ...
  private async autoGenerateJournalVoucher(purchaseReturn: any, ctx?: { userId?: string }) {
    ...
    for (const group of brandGroupsMap.values()) {
      ...
      details.push({
        ...
        credit: 0,
        narration: `REC ${quantity} Pcs. of ${brandName} Shipment. ref 1 is ${invoiceNumber} ref 2 is ${grnNumber}`,
      ...
      if (salesTaxAmount > 0) {
        details.push({
          ...
          narration: `REC Sales Tax for ${quantity} Pcs. of ${brandName} Shipment. ref 1 is ${invoiceNumber} ref 2 is ${grnNumber}`,
          refBillNo: invoiceNumber,
          refBillNo2: grnNumber,
          taxType: 'Taxable',
        });
