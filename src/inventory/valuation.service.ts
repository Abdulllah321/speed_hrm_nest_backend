...
export class ValuationService {
    ...
    async recordTransaction(
        ...
        const { itemId, quantity, unitCost, type, documentType, documentId, notes, userId } = data;
        ...
        const currentAvgCost = itemSetting.averageCost ? new Decimal(itemSetting.averageCost) : new Decimal(0);
        ...
        let newQtyBalance = currentQtyDetails.plus(qty);
        ...
        this.logger.log(`Recorded ${type} for Item ${itemId}: Qty ${qty}, Cost ${cost}, New WAC ${newAvgCost}`);
        return transaction;
    }
