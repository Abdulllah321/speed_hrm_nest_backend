...
export interface QueueChartOfAccountExportOptions {
  userId: string;
  search?: string;
  type?: string;
  isGroup?: boolean;
...
@Injectable()
export class ChartOfAccountExportService {
  private readonly logger = new Logger(ChartOfAccountExportService.name);

  constructor(
    @InjectQueue('chart-of-account-export') private readonly exportQueue: Queue,
