...
export class EquipmentController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Laptop' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { name: { type: 'string', example: 'Monitor' }, status: { type: 'string', example: 'active' } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { name: { type: 'string' }, status: { type: 'string' } }, example: [{ name: 'Laptop' }] } } } } })
  ...
  @ApiBody({ schema: { type: 'object', properties: { items: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, name: { type: 'string' }, status: { type: 'string' } }, example: [{ id: 'uuid', name: 'Monitor' }] } } } } })
